...
user/_p4:     file format elf64-littleriscv
...
int main() {
   ...
   6:	0800                	addi	s0,sp,16
    ...
    printf("Parent pid: %d\n", getpid());
   8:	38e000ef          	jal	ra,396 <getpid>
   c:	85aa                	mv	a1,a0
   e:	00001517          	auipc	a0,0x1
  12:	8f250513          	addi	a0,a0,-1806 # 900 <malloc+0xe4>
  16:	74c000ef          	jal	ra,762 <printf>

    for (i = 0; i < 3; i++) {
        pid = fork();
  1a:	2f4000ef          	jal	ra,30e <fork>
        if (pid == 0) {
  1e:	c939                	beqz	a0,74 <main+0x74>
        pid = fork();
  20:	2ee000ef          	jal	ra,30e <fork>
        if (pid == 0) {
  24:	c921                	beqz	a0,74 <main+0x74>
        pid = fork();
  26:	2e8000ef          	jal	ra,30e <fork>
        if (pid == 0) {
  2a:	c529                	beqz	a0,74 <main+0x74>
            pause(10);
            exit(0);
        }
    }
    ...
    pause(5);
  2c:	4515                	li	a0,5
  2e:	378000ef          	jal	ra,3a6 <pause>
    getProcessStates();
  32:	38c000ef          	jal	ra,3be <getProcessStates>
    pause(30);
  36:	4579                	li	a0,30
  38:	36e000ef          	jal	ra,3a6 <pause>

    printf("\n=== Process states after exiting ===\n");
  3c:	00001517          	auipc	a0,0x1
  40:	8d450513          	addi	a0,a0,-1836 # 910 <malloc+0xf4>
  44:	71e000ef          	jal	ra,762 <printf>
    getProcessStates();
  48:	376000ef          	jal	ra,3be <getProcessStates>

    for (i = 0; i < 3; i++) wait(0);
  4c:	4501                	li	a0,0
  4e:	2d0000ef          	jal	ra,31e <wait>
  52:	4501                	li	a0,0
  54:	2ca000ef          	jal	ra,31e <wait>
  58:	4501                	li	a0,0
  5a:	2c4000ef          	jal	ra,31e <wait>

    printf("\n=== Process states reaping ===\n");
  5e:	00001517          	auipc	a0,0x1
  62:	8da50513          	addi	a0,a0,-1830 # 938 <malloc+0x11c>
  66:	6fc000ef          	jal	ra,762 <printf>
    getProcessStates();
  6a:	354000ef          	jal	ra,3be <getProcessStates>

    exit(0);
  6e:	4501                	li	a0,0
  70:	2a6000ef          	jal	ra,316 <exit>
            pause(10);
  74:	4529                	li	a0,10
  76:	330000ef          	jal	ra,3a6 <pause>
            exit(0);
  7a:	4501                	li	a0,0
  7c:	29a000ef          	jal	ra,316 <exit>
...
start(int argc, char **argv)
{
  ...
  r = main(argc, argv);
  88:	f79ff0ef          	jal	ra,0 <main>
  exit(r);
  8c:	28a000ef          	jal	ra,316 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	892e                	mv	s2,a1
  ...
  fd = open(n, O_RDONLY);
 1c6:	4581                	li	a1,0
 1c8:	18e000ef          	jal	ra,356 <open>
  if(fd < 0)
 1cc:	02054163          	bltz	a0,1ee <stat+0x36>
 1d0:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 1d2:	85ca                	mv	a1,s2
 1d4:	19a000ef          	jal	ra,36e <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	162000ef          	jal	ra,33e <close>
  return r;
}
 1e0:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 2d6:	f67ff0ef          	jal	ra,23c <memmove>
}
 2da:	60a2                	ld	ra,8(sp)
 2dc:	6402                	ld	s0,0(sp)
...
sbrk(int n) {
 ...
 2ea:	4585                	li	a1,1
 2ec:	0b2000ef          	jal	ra,39e <sys_sbrk>
}
 2f0:	60a2                	ld	ra,8(sp)
 2f2:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 300:	4589                	li	a1,2
 302:	09c000ef          	jal	ra,39e <sys_sbrk>
}
 306:	60a2                	ld	ra,8(sp)
 308:	6402                	ld	s0,0(sp)
...
00000000000003be <getProcessStates>:
...
00000000000003ce <getChildCount>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 426:	54650513          	addi	a0,a0,1350 # 968 <digits>
 42a:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e6:	486c8c93          	addi	s9,s9,1158 # 968 <digits>
 ...
 70a:	25a90913          	addi	s2,s2,602 # 960 <malloc+0x144>
        for(; *s; s++)
