...
user/_p2:     file format elf64-littleriscv
...
int main(int argc, char* argv[]) {
   ...
   8:	1000                	addi	s0,sp,32
    ...
    int f=fork();
   a:	2d0000ef          	jal	ra,2da <fork>
    if(f==0){
   e:	c519                	beqz	a0,1c <main+0x1c>
  10:	84aa                	mv	s1,a0
        printf("in child %d\n",getpid());
    }
    else if(f>0){
  12:	00a04f63          	bgtz	a0,30 <main+0x30>
        wait(0);
        printf("%d,child: %d\n",getpid(),f);
    }
    ...
    exit(0);
  16:	4501                	li	a0,0
  18:	2ca000ef          	jal	ra,2e2 <exit>
        printf("in child %d\n",getpid());
  1c:	346000ef          	jal	ra,362 <getpid>
  20:	85aa                	mv	a1,a0
  22:	00001517          	auipc	a0,0x1
  26:	8ae50513          	addi	a0,a0,-1874 # 8d0 <malloc+0xe8>
  2a:	704000ef          	jal	ra,72e <printf>
  2e:	b7e5                	j	16 <main+0x16>
        wait(0);
  30:	4501                	li	a0,0
  32:	2b8000ef          	jal	ra,2ea <wait>
        printf("%d,child: %d\n",getpid(),f);
  36:	32c000ef          	jal	ra,362 <getpid>
  3a:	85aa                	mv	a1,a0
  3c:	8626                	mv	a2,s1
  3e:	00001517          	auipc	a0,0x1
  42:	8a250513          	addi	a0,a0,-1886 # 8e0 <malloc+0xf8>
  46:	6e8000ef          	jal	ra,72e <printf>
  4a:	b7f1                	j	16 <main+0x16>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f2:	50a50513          	addi	a0,a0,1290 # 8f8 <digits>
 3f6:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	44ac8c93          	addi	s9,s9,1098 # 8f8 <digits>
 ...
 6d6:	21e90913          	addi	s2,s2,542 # 8f0 <malloc+0x108>
        for(; *s; s++)
