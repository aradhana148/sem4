...
main(int argc, char *argv[])
{
  ...
  42:	4509                	li	a0,2
  44:	6d8000ef          	jal	ra,71c <fprintf>
    exit(1);
  48:	4505                	li	a0,1
  ...
  58:	4509                	li	a0,2
  5a:	6c2000ef          	jal	ra,71c <fprintf>
      break;
    }
  }
...
00000000000003a2 <getProcessStates>:
...
00000000000003b2 <getChildCount>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3fa:	0805c163          	bltz	a1,47c <printint+0x94>
  neg = 0;
 3fe:	4881                	li	a7,0
 ...
 40a:	51a50513          	addi	a0,a0,1306 # 920 <digits>
 40e:	883e                	mv	a6,a5
 ...
 428:	fec773e3          	bgeu	a4,a2,40e <printint+0x26>
  if(neg)
 42c:	00088b63          	beqz	a7,442 <printint+0x5a>
    buf[i++] = '-';
 430:	fd040713          	addi	a4,s0,-48
 ...
 43e:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 442:	02f05663          	blez	a5,46e <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	24090c63          	beqz	s2,6fe <vprintf+0x27a>
 4aa:	8b2a                	mv	s6,a0
 4ac:	8a2e                	mv	s4,a1
 4ae:	8bb2                	mv	s7,a2
  state = 0;
 ...
 4ca:	45ac8c93          	addi	s9,s9,1114 # 920 <digits>
 4ce:	a005                	j	4ee <vprintf+0x6a>
        putc(fd, c0);
 4d0:	85ca                	mv	a1,s2
 4d2:	855a                	mv	a0,s6
 4d4:	ef7ff0ef          	jal	ra,3ca <putc>
 ...
 4ea:	20090a63          	beqz	s2,6fe <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 ...
 4fc:	b7cd                	j	4de <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 4fe:	c3c1                	beqz	a5,57e <vprintf+0xfa>
 ...
 50e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 512:	03878e63          	beq	a5,s8,54e <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 516:	05a78863          	beq	a5,s10,566 <vprintf+0xe2>
      } else if(c0 == 'u'){
 51a:	0db78b63          	beq	a5,s11,5f0 <vprintf+0x16c>
 ...
 522:	10e78d63          	beq	a5,a4,63c <vprintf+0x1b8>
 ...
 52a:	14e78263          	beq	a5,a4,66e <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 52e:	06300713          	li	a4,99
 532:	16e78f63          	beq	a5,a4,6b0 <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 536:	07300713          	li	a4,115
 53a:	18e78563          	beq	a5,a4,6c4 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 53e:	05579063          	bne	a5,s5,57e <vprintf+0xfa>
        putc(fd, '%');
 542:	85d6                	mv	a1,s5
 544:	855a                	mv	a0,s6
 546:	e85ff0ef          	jal	ra,3ca <putc>
 ...
 55a:	855a                	mv	a0,s6
 55c:	e8dff0ef          	jal	ra,3e8 <printint>
 560:	8bca                	mv	s7,s2
      state = 0;
 562:	4981                	li	s3,0
 564:	bfad                	j	4de <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 566:	03868663          	beq	a3,s8,592 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 56a:	05a68163          	beq	a3,s10,5ac <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 56e:	09b68d63          	beq	a3,s11,608 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 572:	03a68f63          	beq	a3,s10,5b0 <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 576:	07800793          	li	a5,120
 57a:	0cf68d63          	beq	a3,a5,654 <vprintf+0x1d0>
        putc(fd, '%');
 57e:	85d6                	mv	a1,s5
 580:	855a                	mv	a0,s6
 582:	e49ff0ef          	jal	ra,3ca <putc>
        putc(fd, c0);
 586:	85ca                	mv	a1,s2
 588:	855a                	mv	a0,s6
 58a:	e41ff0ef          	jal	ra,3ca <putc>
      state = 0;
 58e:	4981                	li	s3,0
 590:	b7b9                	j	4de <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 59e:	855a                	mv	a0,s6
 5a0:	e49ff0ef          	jal	ra,3e8 <printint>
        i += 1;
 ...
 5a8:	4981                	li	s3,0
        i += 1;
 5aa:	bf15                	j	4de <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 5ac:	03860563          	beq	a2,s8,5d6 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 5b0:	07b60963          	beq	a2,s11,622 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 5b4:	07800793          	li	a5,120
 5b8:	fcf613e3          	bne	a2,a5,57e <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5c8:	855a                	mv	a0,s6
 5ca:	e1fff0ef          	jal	ra,3e8 <printint>
        i += 2;
 ...
 5e2:	855a                	mv	a0,s6
 5e4:	e05ff0ef          	jal	ra,3e8 <printint>
        i += 2;
 ...
 5fc:	855a                	mv	a0,s6
 5fe:	debff0ef          	jal	ra,3e8 <printint>
 602:	8bca                	mv	s7,s2
      state = 0;
 604:	4981                	li	s3,0
 606:	bde1                	j	4de <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 614:	855a                	mv	a0,s6
 616:	dd3ff0ef          	jal	ra,3e8 <printint>
        i += 1;
 ...
 62e:	855a                	mv	a0,s6
 630:	db9ff0ef          	jal	ra,3e8 <printint>
        i += 2;
 ...
 648:	855a                	mv	a0,s6
 64a:	d9fff0ef          	jal	ra,3e8 <printint>
 64e:	8bca                	mv	s7,s2
      state = 0;
 650:	4981                	li	s3,0
 652:	b571                	j	4de <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 660:	855a                	mv	a0,s6
 662:	d87ff0ef          	jal	ra,3e8 <printint>
        i += 1;
 ...
 69a:	855a                	mv	a0,s6
 69c:	d2fff0ef          	jal	ra,3ca <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6a0:	0992                	slli	s3,s3,0x4
 6a2:	397d                	addiw	s2,s2,-1
 6a4:	fe0916e3          	bnez	s2,690 <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 6a8:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 6ac:	4981                	li	s3,0
 6ae:	bd05                	j	4de <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 6b0:	008b8913          	addi	s2,s7,8
 6b4:	000bc583          	lbu	a1,0(s7)
 6b8:	855a                	mv	a0,s6
 6ba:	d11ff0ef          	jal	ra,3ca <putc>
 6be:	8bca                	mv	s7,s2
      state = 0;
 6c0:	4981                	li	s3,0
 6c2:	bd31                	j	4de <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 6c4:	008b8993          	addi	s3,s7,8
 6c8:	000bb903          	ld	s2,0(s7)
 6cc:	00090f63          	beqz	s2,6ea <vprintf+0x266>
        for(; *s; s++)
 6d0:	00094583          	lbu	a1,0(s2)
 6d4:	c195                	beqz	a1,6f8 <vprintf+0x274>
          putc(fd, *s);
 6d6:	855a                	mv	a0,s6
 6d8:	cf3ff0ef          	jal	ra,3ca <putc>
        for(; *s; s++)
 6dc:	0905                	addi	s2,s2,1
 6de:	00094583          	lbu	a1,0(s2)
 6e2:	f9f5                	bnez	a1,6d6 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6e4:	8bce                	mv	s7,s3
      state = 0;
 6e6:	4981                	li	s3,0
 6e8:	bbdd                	j	4de <vprintf+0x5a>
          s = "(null)";
 6ea:	00000917          	auipc	s2,0x0
 6ee:	22e90913          	addi	s2,s2,558 # 918 <malloc+0x118>
        for(; *s; s++)
 6f2:	02800593          	li	a1,40
 6f6:	b7c5                	j	6d6 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6f8:	8bce                	mv	s7,s3
      state = 0;
 6fa:	4981                	li	s3,0
 6fc:	b3cd                	j	4de <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 734:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 738:	8622                	mv	a2,s0
 73a:	d4bff0ef          	jal	ra,484 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 768:	85aa                	mv	a1,a0
 76a:	4505                	li	a0,1
 76c:	d19ff0ef          	jal	ra,484 <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 8b2:	ec7ff0ef          	jal	ra,778 <free>
  return freep;
 8b6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 8ba:	dd61                	beqz	a0,892 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8bc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8be:	4798                	lw	a4,8(a5)
 8c0:	fa9778e3          	bgeu	a4,s1,870 <malloc+0x70>
    if(p == freep)
 8c4:	00093703          	ld	a4,0(s2)
 8c8:	853e                	mv	a0,a5
 8ca:	fef719e3          	bne	a4,a5,8bc <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 8ce:	8552                	mv	a0,s4
 8d0:	9f7ff0ef          	jal	ra,2c6 <sbrk>
  if(p == SBRK_ERROR)
 8d4:	fd551ce3          	bne	a0,s5,8ac <malloc+0xac>
        return 0;
 8d8:	4501                	li	a0,0
 8da:	bf65                	j	892 <malloc+0x92>
