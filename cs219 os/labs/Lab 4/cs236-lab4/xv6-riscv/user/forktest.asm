...
forktest(void)
{
  ...
  36:	41650513          	addi	a0,a0,1046 # 448 <xtrace_end+0xc>
  ...
  58:	40450513          	addi	a0,a0,1028 # 458 <xtrace_end+0x1c>
  ...
  94:	41850513          	addi	a0,a0,1048 # 4a8 <xtrace_end+0x6c>
  ...
  ac:	3d050513          	addi	a0,a0,976 # 478 <xtrace_end+0x3c>
  ...
  be:	3d650513          	addi	a0,a0,982 # 490 <xtrace_end+0x54>
...
000000000000041c <getProcessStates>:
...
000000000000042c <getChildCount>:
