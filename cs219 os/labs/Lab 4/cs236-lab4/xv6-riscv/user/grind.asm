...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	11e50513          	addi	a0,a0,286 # 11b0 <malloc+0xe4>
      9a:	395000ef          	jal	ra,c2e <mkdir>
  if(chdir("grindir") != 0){
      9e:	00001517          	auipc	a0,0x1
      a2:	11250513          	addi	a0,a0,274 # 11b0 <malloc+0xe4>
      a6:	391000ef          	jal	ra,c36 <chdir>
      aa:	c911                	beqz	a0,be <go+0x4a>
    printf("grind: chdir grindir failed\n");
      ac:	00001517          	auipc	a0,0x1
      b0:	10c50513          	addi	a0,a0,268 # 11b8 <malloc+0xec>
      b4:	75f000ef          	jal	ra,1012 <printf>
    exit(1);
      b8:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      c2:	11a50513          	addi	a0,a0,282 # 11d8 <malloc+0x10c>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ce:	11e98993          	addi	s3,s3,286 # 11e8 <malloc+0x11c>
      d2:	c489                	beqz	s1,dc <go+0x68>
      d4:	00001997          	auipc	s3,0x1
      d8:	10c98993          	addi	s3,s3,268 # 11e0 <malloc+0x114>
    iters++;
      dc:	4485                	li	s1,1
  int fd = -1;
      de:	597d                	li	s2,-1
      ...
      f2:	10250513          	addi	a0,a0,258 # 11f0 <malloc+0x124>
    ...
    if(what == 1){
     ...
     242:	22a58593          	addi	a1,a1,554 # 1468 <malloc+0x39c>
     ...
     262:	21250513          	addi	a0,a0,530 # 1470 <malloc+0x3a4>
     266:	5ad000ef          	jal	ra,1012 <printf>
        exit(1);
     26a:	4505                	li	a0,1
     ...
     2dc:	f4850513          	addi	a0,a0,-184 # 1220 <malloc+0x154>
     ...
     2f6:	f3e50513          	addi	a0,a0,-194 # 1230 <malloc+0x164>
     ...
     3d8:	edc50513          	addi	a0,a0,-292 # 12b0 <malloc+0x1e4>
     3dc:	437000ef          	jal	ra,1012 <printf>
        exit(1);
     3e0:	4505                	li	a0,1
     ...
     40a:	eaa50513          	addi	a0,a0,-342 # 12b0 <malloc+0x1e4>
     40e:	405000ef          	jal	ra,1012 <printf>
        exit(1);
     412:	4505                	li	a0,1
     414:	7b2000ef          	jal	ra,bc6 <exit>
      sbrk(6011);
     418:	6505                	lui	a0,0x1
     41a:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x2db>
     ...
     44e:	e7e50513          	addi	a0,a0,-386 # 12c8 <malloc+0x1fc>
     ...
     46e:	e2650513          	addi	a0,a0,-474 # 1290 <malloc+0x1c4>
     ...
     484:	e3050513          	addi	a0,a0,-464 # 12b0 <malloc+0x1e4>
     488:	38b000ef          	jal	ra,1012 <printf>
        exit(1);
     48c:	4505                	li	a0,1
     48e:	738000ef          	jal	ra,bc6 <exit>
        printf("grind: chdir failed\n");
     492:	00001517          	auipc	a0,0x1
     496:	e4650513          	addi	a0,a0,-442 # 12d8 <malloc+0x20c>
     49a:	379000ef          	jal	ra,1012 <printf>
        exit(1);
     49e:	4505                	li	a0,1
     ...
     4c8:	dec50513          	addi	a0,a0,-532 # 12b0 <malloc+0x1e4>
     4cc:	347000ef          	jal	ra,1012 <printf>
        exit(1);
     4d0:	4505                	li	a0,1
     ...
     508:	dec50513          	addi	a0,a0,-532 # 12f0 <malloc+0x224>
     50c:	307000ef          	jal	ra,1012 <printf>
        exit(1);
     510:	4505                	li	a0,1
     ...
     524:	de858593          	addi	a1,a1,-536 # 1308 <malloc+0x23c>
     ...
     554:	dc050513          	addi	a0,a0,-576 # 1310 <malloc+0x244>
     558:	2bb000ef          	jal	ra,1012 <printf>
     55c:	bfe9                	j	536 <go+0x4c2>
          printf("grind: pipe read failed\n");
     55e:	00001517          	auipc	a0,0x1
     562:	dd250513          	addi	a0,a0,-558 # 1330 <malloc+0x264>
     566:	2ad000ef          	jal	ra,1012 <printf>
     56a:	b7c5                	j	54a <go+0x4d6>
        printf("grind: fork failed\n");
     56c:	00001517          	auipc	a0,0x1
     570:	d4450513          	addi	a0,a0,-700 # 12b0 <malloc+0x1e4>
     574:	29f000ef          	jal	ra,1012 <printf>
        exit(1);
     578:	4505                	li	a0,1
     ...
     5e6:	cce50513          	addi	a0,a0,-818 # 12b0 <malloc+0x1e4>
     5ea:	229000ef          	jal	ra,1012 <printf>
        exit(1);
     5ee:	4505                	li	a0,1
     5f0:	5d6000ef          	jal	ra,bc6 <exit>
      unlink("c");
     5f4:	00001517          	auipc	a0,0x1
     5f8:	d5c50513          	addi	a0,a0,-676 # 1350 <malloc+0x284>
     5fc:	61a000ef          	jal	ra,c16 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     600:	20200593          	li	a1,514
     604:	00001517          	auipc	a0,0x1
     608:	d4c50513          	addi	a0,a0,-692 # 1350 <malloc+0x284>
     ...
     61c:	cf058593          	addi	a1,a1,-784 # 1308 <malloc+0x23c>
     ...
     656:	cfe50513          	addi	a0,a0,-770 # 1350 <malloc+0x284>
     65a:	5bc000ef          	jal	ra,c16 <unlink>
     65e:	b445                	j	fe <go+0x8a>
        printf("grind: create c failed\n");
     660:	00001517          	auipc	a0,0x1
     664:	cf850513          	addi	a0,a0,-776 # 1358 <malloc+0x28c>
     668:	1ab000ef          	jal	ra,1012 <printf>
        exit(1);
     66c:	4505                	li	a0,1
     66e:	558000ef          	jal	ra,bc6 <exit>
        printf("grind: write c failed\n");
     672:	00001517          	auipc	a0,0x1
     676:	cfe50513          	addi	a0,a0,-770 # 1370 <malloc+0x2a4>
     67a:	199000ef          	jal	ra,1012 <printf>
        exit(1);
     67e:	4505                	li	a0,1
     680:	546000ef          	jal	ra,bc6 <exit>
        printf("grind: fstat failed\n");
     684:	00001517          	auipc	a0,0x1
     688:	d0450513          	addi	a0,a0,-764 # 1388 <malloc+0x2bc>
     68c:	187000ef          	jal	ra,1012 <printf>
        exit(1);
     690:	4505                	li	a0,1
     ...
     69c:	d0850513          	addi	a0,a0,-760 # 13a0 <malloc+0x2d4>
     6a0:	173000ef          	jal	ra,1012 <printf>
        exit(1);
     6a4:	4505                	li	a0,1
     6a6:	520000ef          	jal	ra,bc6 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     6aa:	00001517          	auipc	a0,0x1
     6ae:	d1e50513          	addi	a0,a0,-738 # 13c8 <malloc+0x2fc>
     6b2:	161000ef          	jal	ra,1012 <printf>
        exit(1);
     6b6:	4505                	li	a0,1
     6b8:	50e000ef          	jal	ra,bc6 <exit>
        fprintf(2, "grind: pipe failed\n");
     6bc:	00001597          	auipc	a1,0x1
     6c0:	c3458593          	addi	a1,a1,-972 # 12f0 <malloc+0x224>
     6c4:	4509                	li	a0,2
     6c6:	123000ef          	jal	ra,fe8 <fprintf>
        exit(1);
     6ca:	4505                	li	a0,1
     6cc:	4fa000ef          	jal	ra,bc6 <exit>
        fprintf(2, "grind: pipe failed\n");
     6d0:	00001597          	auipc	a1,0x1
     6d4:	c2058593          	addi	a1,a1,-992 # 12f0 <malloc+0x224>
     6d8:	4509                	li	a0,2
     6da:	10f000ef          	jal	ra,fe8 <fprintf>
        exit(1);
     6de:	4505                	li	a0,1
     ...
     714:	ce058593          	addi	a1,a1,-800 # 13f0 <malloc+0x324>
     718:	4509                	li	a0,2
     71a:	0cf000ef          	jal	ra,fe8 <fprintf>
          exit(1);
     71e:	4505                	li	a0,1
     ...
     730:	cdc78793          	addi	a5,a5,-804 # 1408 <malloc+0x33c>
     734:	faf43423          	sd	a5,-88(s0)
     738:	00001797          	auipc	a5,0x1
     73c:	cd878793          	addi	a5,a5,-808 # 1410 <malloc+0x344>
     740:	faf43823          	sd	a5,-80(s0)
     744:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     748:	fa840593          	addi	a1,s0,-88
     74c:	00001517          	auipc	a0,0x1
     750:	ccc50513          	addi	a0,a0,-820 # 1418 <malloc+0x34c>
     754:	4aa000ef          	jal	ra,bfe <exec>
        fprintf(2, "grind: echo: not found\n");
     758:	00001597          	auipc	a1,0x1
     75c:	cd058593          	addi	a1,a1,-816 # 1428 <malloc+0x35c>
     760:	4509                	li	a0,2
     762:	087000ef          	jal	ra,fe8 <fprintf>
        exit(2);
     766:	4509                	li	a0,2
     768:	45e000ef          	jal	ra,bc6 <exit>
        fprintf(2, "grind: fork failed\n");
     76c:	00001597          	auipc	a1,0x1
     770:	b4458593          	addi	a1,a1,-1212 # 12b0 <malloc+0x1e4>
     774:	4509                	li	a0,2
     776:	073000ef          	jal	ra,fe8 <fprintf>
        exit(3);
     77a:	450d                	li	a0,3
     ...
     7a4:	c5058593          	addi	a1,a1,-944 # 13f0 <malloc+0x324>
     7a8:	4509                	li	a0,2
     7aa:	03f000ef          	jal	ra,fe8 <fprintf>
          exit(4);
     7ae:	4511                	li	a0,4
     ...
     7d4:	c2058593          	addi	a1,a1,-992 # 13f0 <malloc+0x324>
     7d8:	4509                	li	a0,2
     7da:	00f000ef          	jal	ra,fe8 <fprintf>
          exit(5);
     7de:	4515                	li	a0,5
     ...
     7f0:	c5478793          	addi	a5,a5,-940 # 1440 <malloc+0x374>
     7f4:	faf43423          	sd	a5,-88(s0)
     7f8:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     7fc:	fa840593          	addi	a1,s0,-88
     800:	00001517          	auipc	a0,0x1
     804:	c4850513          	addi	a0,a0,-952 # 1448 <malloc+0x37c>
     808:	3f6000ef          	jal	ra,bfe <exec>
        fprintf(2, "grind: cat: not found\n");
     80c:	00001597          	auipc	a1,0x1
     810:	c4458593          	addi	a1,a1,-956 # 1450 <malloc+0x384>
     814:	4509                	li	a0,2
     816:	7d2000ef          	jal	ra,fe8 <fprintf>
        exit(6);
     81a:	4519                	li	a0,6
     81c:	3aa000ef          	jal	ra,bc6 <exit>
        fprintf(2, "grind: fork failed\n");
     820:	00001597          	auipc	a1,0x1
     824:	a9058593          	addi	a1,a1,-1392 # 12b0 <malloc+0x1e4>
     828:	4509                	li	a0,2
     82a:	7be000ef          	jal	ra,fe8 <fprintf>
        exit(7);
     82e:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     844:	a5050513          	addi	a0,a0,-1456 # 1290 <malloc+0x1c4>
     848:	3ce000ef          	jal	ra,c16 <unlink>
  unlink("b");
     84c:	00001517          	auipc	a0,0x1
     850:	9f450513          	addi	a0,a0,-1548 # 1240 <malloc+0x174>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     87e:	a3650513          	addi	a0,a0,-1482 # 12b0 <malloc+0x1e4>
     882:	790000ef          	jal	ra,1012 <printf>
    exit(1);
     886:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     8a0:	629c                	ld	a5,0(a3)
     8a2:	6709                	lui	a4,0x2
     8a4:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x769>
    ...
    printf("grind: fork failed\n");
     ...
     8b6:	9fe50513          	addi	a0,a0,-1538 # 12b0 <malloc+0x1e4>
     8ba:	758000ef          	jal	ra,1012 <printf>
    exit(1);
     8be:	4505                	li	a0,1
...
0000000000000c6e <getProcessStates>:
...
0000000000000c7e <getChildCount>:
...
putc(int fd, char c)
{
     ...
     c9e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     ca2:	4605                	li	a2,1
     ca4:	fef40593          	addi	a1,s0,-17
     ca8:	f3fff0ef          	jal	ra,be6 <write>
}
...
0000000000000cb4 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     cb4:	715d                	addi	sp,sp,-80
     cb6:	e486                	sd	ra,72(sp)
     cb8:	e0a2                	sd	s0,64(sp)
     cba:	fc26                	sd	s1,56(sp)
     cbc:	f84a                	sd	s2,48(sp)
     cbe:	f44e                	sd	s3,40(sp)
     cc0:	0880                	addi	s0,sp,80
     cc2:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     cc4:	c299                	beqz	a3,cca <printint+0x16>
     cc6:	0805c163          	bltz	a1,d48 <printint+0x94>
  neg = 0;
     cca:	4881                	li	a7,0
     ccc:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     cd6:	7ce50513          	addi	a0,a0,1998 # 14a0 <digits>
     cda:	883e                	mv	a6,a5
     cdc:	2785                	addiw	a5,a5,1
     cde:	02c5f733          	remu	a4,a1,a2
     ce2:	972a                	add	a4,a4,a0
     ce4:	00074703          	lbu	a4,0(a4)
     ce8:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     cec:	872e                	mv	a4,a1
     cee:	02c5d5b3          	divu	a1,a1,a2
     cf2:	0685                	addi	a3,a3,1
     cf4:	fec773e3          	bgeu	a4,a2,cda <printint+0x26>
  if(neg)
     cf8:	00088b63          	beqz	a7,d0e <printint+0x5a>
    buf[i++] = '-';
     cfc:	fd040713          	addi	a4,s0,-48
     d00:	97ba                	add	a5,a5,a4
     d02:	02d00713          	li	a4,45
     d06:	fee78423          	sb	a4,-24(a5)
     d0a:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d0e:	02f05663          	blez	a5,d3a <printint+0x86>
     d12:	fb840713          	addi	a4,s0,-72
     d16:	00f704b3          	add	s1,a4,a5
     d1a:	fff70993          	addi	s3,a4,-1
     d1e:	99be                	add	s3,s3,a5
     d20:	37fd                	addiw	a5,a5,-1
     d22:	1782                	slli	a5,a5,0x20
     d24:	9381                	srli	a5,a5,0x20
     d26:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     d2a:	fff4c583          	lbu	a1,-1(s1)
     d2e:	854a                	mv	a0,s2
     d30:	f67ff0ef          	jal	ra,c96 <putc>
  while(--i >= 0)
     d34:	14fd                	addi	s1,s1,-1
     d36:	ff349ae3          	bne	s1,s3,d2a <printint+0x76>
}
     d3a:	60a6                	ld	ra,72(sp)
     d3c:	6406                	ld	s0,64(sp)
     d3e:	74e2                	ld	s1,56(sp)
     d40:	7942                	ld	s2,48(sp)
     d42:	79a2                	ld	s3,40(sp)
     d44:	6161                	addi	sp,sp,80
     d46:	8082                	ret
    x = -xx;
    ...
    neg = 1;
     d4c:	4885                	li	a7,1
    x = -xx;
     d4e:	bfbd                	j	ccc <printint+0x18>

0000000000000d50 <vprintf>:
}
...
{
     d50:	7119                	addi	sp,sp,-128
     d52:	fc86                	sd	ra,120(sp)
     d54:	f8a2                	sd	s0,112(sp)
     d56:	f4a6                	sd	s1,104(sp)
     d58:	f0ca                	sd	s2,96(sp)
     d5a:	ecce                	sd	s3,88(sp)
     d5c:	e8d2                	sd	s4,80(sp)
     d5e:	e4d6                	sd	s5,72(sp)
     d60:	e0da                	sd	s6,64(sp)
     d62:	fc5e                	sd	s7,56(sp)
     d64:	f862                	sd	s8,48(sp)
     d66:	f466                	sd	s9,40(sp)
     d68:	f06a                	sd	s10,32(sp)
     d6a:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     d6e:	0005c903          	lbu	s2,0(a1)
     d72:	24090c63          	beqz	s2,fca <vprintf+0x27a>
     d76:	8b2a                	mv	s6,a0
     d78:	8a2e                	mv	s4,a1
     d7a:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     d8e:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     d92:	00000c97          	auipc	s9,0x0
     d96:	70ec8c93          	addi	s9,s9,1806 # 14a0 <digits>
     d9a:	a005                	j	dba <vprintf+0x6a>
        putc(fd, c0);
     d9c:	85ca                	mv	a1,s2
     d9e:	855a                	mv	a0,s6
     da0:	ef7ff0ef          	jal	ra,c96 <putc>
     da4:	a019                	j	daa <vprintf+0x5a>
    } else if(state == '%'){
     da6:	03598263          	beq	s3,s5,dca <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     daa:	2485                	addiw	s1,s1,1
     dac:	8726                	mv	a4,s1
     dae:	009a07b3          	add	a5,s4,s1
     db2:	0007c903          	lbu	s2,0(a5)
     db6:	20090a63          	beqz	s2,fca <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
     dba:	0009079b          	sext.w	a5,s2
    if(state == 0){
     dbe:	fe0994e3          	bnez	s3,da6 <vprintf+0x56>
      if(c0 == '%'){
     dc2:	fd579de3          	bne	a5,s5,d9c <vprintf+0x4c>
        state = '%';
     dc6:	89be                	mv	s3,a5
     dc8:	b7cd                	j	daa <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
     dca:	c3c1                	beqz	a5,e4a <vprintf+0xfa>
     dcc:	00ea06b3          	add	a3,s4,a4
     dd0:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     dd4:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     dd6:	c681                	beqz	a3,dde <vprintf+0x8e>
     dd8:	9752                	add	a4,a4,s4
     dda:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     dde:	03878e63          	beq	a5,s8,e1a <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
     de2:	05a78863          	beq	a5,s10,e32 <vprintf+0xe2>
      } else if(c0 == 'u'){
     de6:	0db78b63          	beq	a5,s11,ebc <vprintf+0x16c>
     ...
     dea:	07800713          	li	a4,120
     dee:	10e78d63          	beq	a5,a4,f08 <vprintf+0x1b8>
     ...
     df2:	07000713          	li	a4,112
     df6:	14e78263          	beq	a5,a4,f3a <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     dfa:	06300713          	li	a4,99
     dfe:	16e78f63          	beq	a5,a4,f7c <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e02:	07300713          	li	a4,115
     e06:	18e78563          	beq	a5,a4,f90 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     e0a:	05579063          	bne	a5,s5,e4a <vprintf+0xfa>
        putc(fd, '%');
     e0e:	85d6                	mv	a1,s5
     e10:	855a                	mv	a0,s6
     e12:	e85ff0ef          	jal	ra,c96 <putc>
     ...
     e26:	855a                	mv	a0,s6
     e28:	e8dff0ef          	jal	ra,cb4 <printint>
     e2c:	8bca                	mv	s7,s2
      state = 0;
     e2e:	4981                	li	s3,0
     e30:	bfad                	j	daa <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
     e32:	03868663          	beq	a3,s8,e5e <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e36:	05a68163          	beq	a3,s10,e78 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
     e3a:	09b68d63          	beq	a3,s11,ed4 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e3e:	03a68f63          	beq	a3,s10,e7c <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
     e42:	07800793          	li	a5,120
     e46:	0cf68d63          	beq	a3,a5,f20 <vprintf+0x1d0>
        putc(fd, '%');
     e4a:	85d6                	mv	a1,s5
     e4c:	855a                	mv	a0,s6
     e4e:	e49ff0ef          	jal	ra,c96 <putc>
        putc(fd, c0);
     e52:	85ca                	mv	a1,s2
     e54:	855a                	mv	a0,s6
     e56:	e41ff0ef          	jal	ra,c96 <putc>
      state = 0;
     e5a:	4981                	li	s3,0
     e5c:	b7b9                	j	daa <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     e6a:	855a                	mv	a0,s6
     e6c:	e49ff0ef          	jal	ra,cb4 <printint>
        i += 1;
     ...
     e74:	4981                	li	s3,0
        i += 1;
     e76:	bf15                	j	daa <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e78:	03860563          	beq	a2,s8,ea2 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e7c:	07b60963          	beq	a2,s11,eee <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     e80:	07800793          	li	a5,120
     e84:	fcf613e3          	bne	a2,a5,e4a <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     e94:	855a                	mv	a0,s6
     e96:	e1fff0ef          	jal	ra,cb4 <printint>
        i += 2;
     e9a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
     e9c:	8bca                	mv	s7,s2
      state = 0;
     e9e:	4981                	li	s3,0
        i += 2;
     ea0:	b729                	j	daa <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     eae:	855a                	mv	a0,s6
     eb0:	e05ff0ef          	jal	ra,cb4 <printint>
        i += 2;
     ...
     ec8:	855a                	mv	a0,s6
     eca:	debff0ef          	jal	ra,cb4 <printint>
     ece:	8bca                	mv	s7,s2
      state = 0;
     ed0:	4981                	li	s3,0
     ed2:	bde1                	j	daa <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     ee0:	855a                	mv	a0,s6
     ee2:	dd3ff0ef          	jal	ra,cb4 <printint>
        i += 1;
     ...
     efa:	855a                	mv	a0,s6
     efc:	db9ff0ef          	jal	ra,cb4 <printint>
        i += 2;
     ...
     f14:	855a                	mv	a0,s6
     f16:	d9fff0ef          	jal	ra,cb4 <printint>
     f1a:	8bca                	mv	s7,s2
      state = 0;
     f1c:	4981                	li	s3,0
     f1e:	b571                	j	daa <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f2c:	855a                	mv	a0,s6
     f2e:	d87ff0ef          	jal	ra,cb4 <printint>
        i += 1;
     ...
     f36:	4981                	li	s3,0
        i += 1;
     f38:	bd8d                	j	daa <vprintf+0x5a>
        printptr(fd, va_arg(ap, uint64));
     f3a:	008b8793          	addi	a5,s7,8
     f3e:	f8f43423          	sd	a5,-120(s0)
     f42:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     f46:	03000593          	li	a1,48
     f4a:	855a                	mv	a0,s6
     f4c:	d4bff0ef          	jal	ra,c96 <putc>
  putc(fd, 'x');
     f50:	07800593          	li	a1,120
     f54:	855a                	mv	a0,s6
     f56:	d41ff0ef          	jal	ra,c96 <putc>
     f5a:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f5c:	03c9d793          	srli	a5,s3,0x3c
     f60:	97e6                	add	a5,a5,s9
     f62:	0007c583          	lbu	a1,0(a5)
     f66:	855a                	mv	a0,s6
     f68:	d2fff0ef          	jal	ra,c96 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     f6c:	0992                	slli	s3,s3,0x4
     f6e:	397d                	addiw	s2,s2,-1
     f70:	fe0916e3          	bnez	s2,f5c <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
     f74:	f8843b83          	ld	s7,-120(s0)
      state = 0;
     f78:	4981                	li	s3,0
     f7a:	bd05                	j	daa <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
     f7c:	008b8913          	addi	s2,s7,8
     f80:	000bc583          	lbu	a1,0(s7)
     f84:	855a                	mv	a0,s6
     f86:	d11ff0ef          	jal	ra,c96 <putc>
     f8a:	8bca                	mv	s7,s2
      state = 0;
     f8c:	4981                	li	s3,0
     f8e:	bd31                	j	daa <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
     f90:	008b8993          	addi	s3,s7,8
     f94:	000bb903          	ld	s2,0(s7)
     f98:	00090f63          	beqz	s2,fb6 <vprintf+0x266>
        for(; *s; s++)
     f9c:	00094583          	lbu	a1,0(s2)
     fa0:	c195                	beqz	a1,fc4 <vprintf+0x274>
          putc(fd, *s);
     fa2:	855a                	mv	a0,s6
     fa4:	cf3ff0ef          	jal	ra,c96 <putc>
        for(; *s; s++)
     fa8:	0905                	addi	s2,s2,1
     faa:	00094583          	lbu	a1,0(s2)
     fae:	f9f5                	bnez	a1,fa2 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
     fb0:	8bce                	mv	s7,s3
      state = 0;
     fb2:	4981                	li	s3,0
     fb4:	bbdd                	j	daa <vprintf+0x5a>
          s = "(null)";
     fb6:	00000917          	auipc	s2,0x0
     fba:	4e290913          	addi	s2,s2,1250 # 1498 <malloc+0x3cc>
        for(; *s; s++)
     fbe:	02800593          	li	a1,40
     fc2:	b7c5                	j	fa2 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
     fc4:	8bce                	mv	s7,s3
      state = 0;
     fc6:	4981                	li	s3,0
     fc8:	b3cd                	j	daa <vprintf+0x5a>
    }
  }
}
     fca:	70e6                	ld	ra,120(sp)
     fcc:	7446                	ld	s0,112(sp)
     fce:	74a6                	ld	s1,104(sp)
     fd0:	7906                	ld	s2,96(sp)
     fd2:	69e6                	ld	s3,88(sp)
     fd4:	6a46                	ld	s4,80(sp)
     fd6:	6aa6                	ld	s5,72(sp)
     fd8:	6b06                	ld	s6,64(sp)
     fda:	7be2                	ld	s7,56(sp)
     fdc:	7c42                	ld	s8,48(sp)
     fde:	7ca2                	ld	s9,40(sp)
     fe0:	7d02                	ld	s10,32(sp)
     fe2:	6de2                	ld	s11,24(sp)
     fe4:	6109                	addi	sp,sp,128
     fe6:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  va_start(ap, fmt);
    1000:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1004:	8622                	mv	a2,s0
    1006:	d4bff0ef          	jal	ra,d50 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    1034:	85aa                	mv	a1,a0
    1036:	4505                	li	a0,1
    1038:	d19ff0ef          	jal	ra,d50 <vprintf>
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    104a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    104e:	00001797          	auipc	a5,0x1
    1052:	fc27b783          	ld	a5,-62(a5) # 2010 <freep>
    1056:	a805                	j	1086 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    1058:	4618                	lw	a4,8(a2)
    105a:	9db9                	addw	a1,a1,a4
    105c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1060:	6398                	ld	a4,0(a5)
    1062:	6318                	ld	a4,0(a4)
    1064:	fee53823          	sd	a4,-16(a0)
    1068:	a091                	j	10ac <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    106a:	ff852703          	lw	a4,-8(a0)
    106e:	9e39                	addw	a2,a2,a4
    1070:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    1072:	ff053703          	ld	a4,-16(a0)
    1076:	e398                	sd	a4,0(a5)
    1078:	a099                	j	10be <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    107a:	6398                	ld	a4,0(a5)
    107c:	00e7e463          	bltu	a5,a4,1084 <free+0x40>
    1080:	00e6ea63          	bltu	a3,a4,1094 <free+0x50>
{
    1084:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1086:	fed7fae3          	bgeu	a5,a3,107a <free+0x36>
    108a:	6398                	ld	a4,0(a5)
    108c:	00e6e463          	bltu	a3,a4,1094 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1090:	fee7eae3          	bltu	a5,a4,1084 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1094:	ff852583          	lw	a1,-8(a0)
    1098:	6390                	ld	a2,0(a5)
    109a:	02059713          	slli	a4,a1,0x20
    109e:	9301                	srli	a4,a4,0x20
    10a0:	0712                	slli	a4,a4,0x4
    10a2:	9736                	add	a4,a4,a3
    10a4:	fae60ae3          	beq	a2,a4,1058 <free+0x14>
    bp->s.ptr = p->s.ptr;
    10a8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    10ac:	4790                	lw	a2,8(a5)
    10ae:	02061713          	slli	a4,a2,0x20
    10b2:	9301                	srli	a4,a4,0x20
    10b4:	0712                	slli	a4,a4,0x4
    10b6:	973e                	add	a4,a4,a5
    10b8:	fae689e3          	beq	a3,a4,106a <free+0x26>
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    10e0:	02051493          	slli	s1,a0,0x20
    10e4:	9081                	srli	s1,s1,0x20
    10e6:	04bd                	addi	s1,s1,15
    10e8:	8091                	srli	s1,s1,0x4
    10ea:	0014899b          	addiw	s3,s1,1
    10ee:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    10f0:	00001517          	auipc	a0,0x1
    10f4:	f2053503          	ld	a0,-224(a0) # 2010 <freep>
    10f8:	c515                	beqz	a0,1124 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10fe:	02977f63          	bgeu	a4,s1,113c <malloc+0x70>
    1102:	8a4e                	mv	s4,s3
    1104:	0009871b          	sext.w	a4,s3
    1108:	6685                	lui	a3,0x1
    110a:	00d77363          	bgeu	a4,a3,1110 <malloc+0x44>
    110e:	6a05                	lui	s4,0x1
    1110:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1114:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1118:	00001917          	auipc	s2,0x1
    111c:	ef890913          	addi	s2,s2,-264 # 2010 <freep>
  if(p == SBRK_ERROR)
    1120:	5afd                	li	s5,-1
    1122:	a0bd                	j	1190 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    1124:	00001797          	auipc	a5,0x1
    1128:	2e478793          	addi	a5,a5,740 # 2408 <base>
    ...
    if(p->s.size >= nunits){
    113a:	b7e1                	j	1102 <malloc+0x36>
      if(p->s.size == nunits)
    113c:	02e48b63          	beq	s1,a4,1172 <malloc+0xa6>
        p->s.size -= nunits;
    ...
    1174:	e118                	sd	a4,0(a0)
    1176:	bff1                	j	1152 <malloc+0x86>
  hp->s.size = nu;
    1178:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    117c:	0541                	addi	a0,a0,16
    117e:	ec7ff0ef          	jal	ra,1044 <free>
  return freep;
    1182:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1186:	dd61                	beqz	a0,115e <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1188:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    118a:	4798                	lw	a4,8(a5)
    118c:	fa9778e3          	bgeu	a4,s1,113c <malloc+0x70>
    if(p == freep)
    1190:	00093703          	ld	a4,0(s2)
    1194:	853e                	mv	a0,a5
    1196:	fef719e3          	bne	a4,a5,1188 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
    119a:	8552                	mv	a0,s4
    119c:	9f7ff0ef          	jal	ra,b92 <sbrk>
  if(p == SBRK_ERROR)
    11a0:	fd551ce3          	bne	a0,s5,1178 <malloc+0xac>
        return 0;
    11a4:	4501                	li	a0,0
    11a6:	bf65                	j	115e <malloc+0x92>
