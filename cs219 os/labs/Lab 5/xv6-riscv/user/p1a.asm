...
int main(int argc, char *argv[])
{
   ...
   c:	fcf42e23          	sw	a5,-36(s0)
       ...
       printf("VA: %p valid: %d\n",
  10:	fdc40513          	addi	a0,s0,-36
  14:	384000ef          	jal	ra,398 <pte_valid>
  18:	862a                	mv	a2,a0
  1a:	fdc40593          	addi	a1,s0,-36
  1e:	00001517          	auipc	a0,0x1
  22:	8e250513          	addi	a0,a0,-1822 # 900 <malloc+0xea>
  26:	736000ef          	jal	ra,75c <printf>
              (void *)mapped_va,
              pte_valid(mapped_va));

       printf("VA: %p valid: %d\n",
  2a:	4485                	li	s1,1
  2c:	02049513          	slli	a0,s1,0x20
  30:	368000ef          	jal	ra,398 <pte_valid>
  34:	862a                	mv	a2,a0
  36:	02049593          	slli	a1,s1,0x20
  3a:	00001517          	auipc	a0,0x1
  3e:	8c650513          	addi	a0,a0,-1850 # 900 <malloc+0xea>
  42:	71a000ef          	jal	ra,75c <printf>
              (void *)unmapped_va,
              pte_valid(unmapped_va));

       exit(0);
  46:	4501                	li	a0,0
  48:	2b0000ef          	jal	ra,2f8 <exit>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 420:	50450513          	addi	a0,a0,1284 # 920 <digits>
 424:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	444c8c93          	addi	s9,s9,1092 # 920 <digits>
 ...
 704:	21890913          	addi	s2,s2,536 # 918 <malloc+0x102>
        for(; *s; s++)
