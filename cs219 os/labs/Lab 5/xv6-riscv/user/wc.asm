...
wc(int fd, char *name)
{
  ...
  3c:	9d8a0a13          	addi	s4,s4,-1576 # a10 <malloc+0xe4>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  b2:	97a50513          	addi	a0,a0,-1670 # a28 <malloc+0xfc>
  b6:	7bc000ef          	jal	ra,872 <printf>
}
  ...
  dc:	94050513          	addi	a0,a0,-1728 # a18 <malloc+0xec>
  e0:	792000ef          	jal	ra,872 <printf>
    exit(1);
  e4:	4505                	li	a0,1
  e6:	328000ef          	jal	ra,40e <exit>
...
main(int argc, char *argv[])
{
 ...
 130:	ff3492e3          	bne	s1,s3,114 <main+0x2a>
  ...
  exit(0);
 134:	4501                	li	a0,0
 136:	2d8000ef          	jal	ra,40e <exit>
    wc(0, "");
 13a:	00001597          	auipc	a1,0x1
 13e:	8fe58593          	addi	a1,a1,-1794 # a38 <malloc+0x10c>
 142:	4501                	li	a0,0
 144:	ebdff0ef          	jal	ra,0 <wc>
    exit(0);
 148:	4501                	li	a0,0
 14a:	2c4000ef          	jal	ra,40e <exit>
      printf("wc: cannot open %s\n", argv[i]);
 14e:	608c                	ld	a1,0(s1)
 150:	00001517          	auipc	a0,0x1
 154:	8f050513          	addi	a0,a0,-1808 # a40 <malloc+0x114>
 158:	71a000ef          	jal	ra,872 <printf>
      exit(1);
 15c:	4505                	li	a0,1
 15e:	2b0000ef          	jal	ra,40e <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 2b2:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 2b4:	85ca                	mv	a1,s2
 2b6:	1b0000ef          	jal	ra,466 <fstat>
 2ba:	892a                	mv	s2,a0
  close(fd);
 2bc:	8526                	mv	a0,s1
 2be:	178000ef          	jal	ra,436 <close>
  return r;
}
 2c2:	854a                	mv	a0,s2
...
sbrk(int n) {
 ...
 3cc:	4585                	li	a1,1
 3ce:	0c8000ef          	jal	ra,496 <sys_sbrk>
}
 3d2:	60a2                	ld	ra,8(sp)
 3d4:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 3e2:	4589                	li	a1,2
 3e4:	0b2000ef          	jal	ra,496 <sys_sbrk>
}
 3e8:	60a2                	ld	ra,8(sp)
 3ea:	6402                	ld	s0,0(sp)
...
ugetpid(void)
{
 ...
 3f4:	0800                	addi	s0,sp,16
  return (*(int*)UGET);
 3f6:	040007b7          	lui	a5,0x4000
 3fa:	17f5                	addi	a5,a5,-3
 3fc:	07b2                	slli	a5,a5,0xc
 3fe:	4388                	lw	a0,0(a5)
 400:	6422                	ld	s0,8(sp)
...
00000000000004e6 <getlazyfaults>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 526:	0805c163          	bltz	a1,5a8 <printint+0x94>
  neg = 0;
 52a:	4881                	li	a7,0
 52c:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
 ...
 536:	52e50513          	addi	a0,a0,1326 # a60 <digits>
 53a:	883e                	mv	a6,a5
 53c:	2785                	addiw	a5,a5,1
 53e:	02c5f733          	remu	a4,a1,a2
 542:	972a                	add	a4,a4,a0
 544:	00074703          	lbu	a4,0(a4)
 548:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
 54c:	872e                	mv	a4,a1
 54e:	02c5d5b3          	divu	a1,a1,a2
 552:	0685                	addi	a3,a3,1
 554:	fec773e3          	bgeu	a4,a2,53a <printint+0x26>
  if(neg)
 558:	00088b63          	beqz	a7,56e <printint+0x5a>
    buf[i++] = '-';
 55c:	fd040713          	addi	a4,s0,-48
 560:	97ba                	add	a5,a5,a4
 562:	02d00713          	li	a4,45
 566:	fee78423          	sb	a4,-24(a5) # 3ffffe8 <base+0x3ffedd8>
 56a:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
 56e:	02f05663          	blez	a5,59a <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d2:	24090c63          	beqz	s2,82a <vprintf+0x27a>
 5d6:	8b2a                	mv	s6,a0
 5d8:	8a2e                	mv	s4,a1
 5da:	8bb2                	mv	s7,a2
  state = 0;
 ...
 5ee:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 5f2:	00000c97          	auipc	s9,0x0
 5f6:	46ec8c93          	addi	s9,s9,1134 # a60 <digits>
 5fa:	a005                	j	61a <vprintf+0x6a>
        putc(fd, c0);
 5fc:	85ca                	mv	a1,s2
 5fe:	855a                	mv	a0,s6
 600:	ef7ff0ef          	jal	ra,4f6 <putc>
 604:	a019                	j	60a <vprintf+0x5a>
    } else if(state == '%'){
 606:	03598263          	beq	s3,s5,62a <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 60a:	2485                	addiw	s1,s1,1
 60c:	8726                	mv	a4,s1
 60e:	009a07b3          	add	a5,s4,s1
 612:	0007c903          	lbu	s2,0(a5)
 616:	20090a63          	beqz	s2,82a <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 61a:	0009079b          	sext.w	a5,s2
    if(state == 0){
 61e:	fe0994e3          	bnez	s3,606 <vprintf+0x56>
      if(c0 == '%'){
 622:	fd579de3          	bne	a5,s5,5fc <vprintf+0x4c>
        state = '%';
 626:	89be                	mv	s3,a5
 628:	b7cd                	j	60a <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 62a:	c3c1                	beqz	a5,6aa <vprintf+0xfa>
 62c:	00ea06b3          	add	a3,s4,a4
 630:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 634:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 636:	c681                	beqz	a3,63e <vprintf+0x8e>
 638:	9752                	add	a4,a4,s4
 63a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 63e:	03878e63          	beq	a5,s8,67a <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 642:	05a78863          	beq	a5,s10,692 <vprintf+0xe2>
      } else if(c0 == 'u'){
 646:	0db78b63          	beq	a5,s11,71c <vprintf+0x16c>
 ...
 64e:	10e78d63          	beq	a5,a4,768 <vprintf+0x1b8>
 ...
 656:	14e78263          	beq	a5,a4,79a <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 65a:	06300713          	li	a4,99
 65e:	16e78f63          	beq	a5,a4,7dc <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 662:	07300713          	li	a4,115
 666:	18e78563          	beq	a5,a4,7f0 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 66a:	05579063          	bne	a5,s5,6aa <vprintf+0xfa>
        putc(fd, '%');
 66e:	85d6                	mv	a1,s5
 670:	855a                	mv	a0,s6
 672:	e85ff0ef          	jal	ra,4f6 <putc>
 ...
 686:	855a                	mv	a0,s6
 688:	e8dff0ef          	jal	ra,514 <printint>
 68c:	8bca                	mv	s7,s2
      state = 0;
 68e:	4981                	li	s3,0
 690:	bfad                	j	60a <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 692:	03868663          	beq	a3,s8,6be <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 696:	05a68163          	beq	a3,s10,6d8 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 69a:	09b68d63          	beq	a3,s11,734 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 69e:	03a68f63          	beq	a3,s10,6dc <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 6a2:	07800793          	li	a5,120
 6a6:	0cf68d63          	beq	a3,a5,780 <vprintf+0x1d0>
        putc(fd, '%');
 6aa:	85d6                	mv	a1,s5
 6ac:	855a                	mv	a0,s6
 6ae:	e49ff0ef          	jal	ra,4f6 <putc>
        putc(fd, c0);
 6b2:	85ca                	mv	a1,s2
 6b4:	855a                	mv	a0,s6
 6b6:	e41ff0ef          	jal	ra,4f6 <putc>
      state = 0;
 6ba:	4981                	li	s3,0
 6bc:	b7b9                	j	60a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 6ca:	855a                	mv	a0,s6
 6cc:	e49ff0ef          	jal	ra,514 <printint>
        i += 1;
 ...
 6d4:	4981                	li	s3,0
        i += 1;
 6d6:	bf15                	j	60a <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 6d8:	03860563          	beq	a2,s8,702 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 6dc:	07b60963          	beq	a2,s11,74e <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 6e0:	07800793          	li	a5,120
 6e4:	fcf613e3          	bne	a2,a5,6aa <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 6f4:	855a                	mv	a0,s6
 6f6:	e1fff0ef          	jal	ra,514 <printint>
        i += 2;
 ...
 70e:	855a                	mv	a0,s6
 710:	e05ff0ef          	jal	ra,514 <printint>
        i += 2;
 ...
 728:	855a                	mv	a0,s6
 72a:	debff0ef          	jal	ra,514 <printint>
 72e:	8bca                	mv	s7,s2
      state = 0;
 730:	4981                	li	s3,0
 732:	bde1                	j	60a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 740:	855a                	mv	a0,s6
 742:	dd3ff0ef          	jal	ra,514 <printint>
        i += 1;
 ...
 75a:	855a                	mv	a0,s6
 75c:	db9ff0ef          	jal	ra,514 <printint>
        i += 2;
 ...
 774:	855a                	mv	a0,s6
 776:	d9fff0ef          	jal	ra,514 <printint>
 77a:	8bca                	mv	s7,s2
      state = 0;
 77c:	4981                	li	s3,0
 77e:	b571                	j	60a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 78c:	855a                	mv	a0,s6
 78e:	d87ff0ef          	jal	ra,514 <printint>
        i += 1;
 ...
 7aa:	855a                	mv	a0,s6
 7ac:	d4bff0ef          	jal	ra,4f6 <putc>
  putc(fd, 'x');
 7b0:	07800593          	li	a1,120
 7b4:	855a                	mv	a0,s6
 7b6:	d41ff0ef          	jal	ra,4f6 <putc>
 7ba:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 7c6:	855a                	mv	a0,s6
 7c8:	d2fff0ef          	jal	ra,4f6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 7cc:	0992                	slli	s3,s3,0x4
 7ce:	397d                	addiw	s2,s2,-1
 7d0:	fe0916e3          	bnez	s2,7bc <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 7d4:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 7d8:	4981                	li	s3,0
 7da:	bd05                	j	60a <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 7dc:	008b8913          	addi	s2,s7,8
 7e0:	000bc583          	lbu	a1,0(s7)
 7e4:	855a                	mv	a0,s6
 7e6:	d11ff0ef          	jal	ra,4f6 <putc>
 7ea:	8bca                	mv	s7,s2
      state = 0;
 7ec:	4981                	li	s3,0
 7ee:	bd31                	j	60a <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 7f0:	008b8993          	addi	s3,s7,8
 7f4:	000bb903          	ld	s2,0(s7)
 7f8:	00090f63          	beqz	s2,816 <vprintf+0x266>
        for(; *s; s++)
 7fc:	00094583          	lbu	a1,0(s2)
 800:	c195                	beqz	a1,824 <vprintf+0x274>
          putc(fd, *s);
 802:	855a                	mv	a0,s6
 804:	cf3ff0ef          	jal	ra,4f6 <putc>
        for(; *s; s++)
 808:	0905                	addi	s2,s2,1
 80a:	00094583          	lbu	a1,0(s2)
 80e:	f9f5                	bnez	a1,802 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 810:	8bce                	mv	s7,s3
      state = 0;
 812:	4981                	li	s3,0
 814:	bbdd                	j	60a <vprintf+0x5a>
          s = "(null)";
 816:	00000917          	auipc	s2,0x0
 81a:	24290913          	addi	s2,s2,578 # a58 <malloc+0x12c>
        for(; *s; s++)
 81e:	02800593          	li	a1,40
 822:	b7c5                	j	802 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 824:	8bce                	mv	s7,s3
      state = 0;
 826:	4981                	li	s3,0
 828:	b3cd                	j	60a <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 860:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 864:	8622                	mv	a2,s0
 866:	d4bff0ef          	jal	ra,5b0 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 894:	85aa                	mv	a1,a0
 896:	4505                	li	a0,1
 898:	d19ff0ef          	jal	ra,5b0 <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 97c:	68890913          	addi	s2,s2,1672 # 1000 <freep>
  if(p == SBRK_ERROR)
 980:	5afd                	li	s5,-1
 982:	a0bd                	j	9f0 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
 984:	00001797          	auipc	a5,0x1
 988:	88c78793          	addi	a5,a5,-1908 # 1210 <base>
 ...
 9de:	ec7ff0ef          	jal	ra,8a4 <free>
  return freep;
 9e2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 9e6:	dd61                	beqz	a0,9be <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9e8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 9ea:	4798                	lw	a4,8(a5)
 9ec:	fa9778e3          	bgeu	a4,s1,99c <malloc+0x70>
    if(p == freep)
 9f0:	00093703          	ld	a4,0(s2)
 9f4:	853e                	mv	a0,a5
 9f6:	fef719e3          	bne	a4,a5,9e8 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 9fa:	8552                	mv	a0,s4
 9fc:	9c9ff0ef          	jal	ra,3c4 <sbrk>
  if(p == SBRK_ERROR)
 a00:	fd551ce3          	bne	a0,s5,9d8 <malloc+0xac>
        return 0;
 a04:	4501                	li	a0,0
 a06:	bf65                	j	9be <malloc+0x92>
