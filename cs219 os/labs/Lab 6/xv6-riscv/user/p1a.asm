...
user/_p1a:     file format elf64-littleriscv
...
main(int argc, char* argv[])
{
  ...
  10:	4785                	li	a5,1
  12:	06a7c363          	blt	a5,a0,78 <main+0x78>

    int pids[N];
    int parent_id = getpid();
  16:	3e4000ef          	jal	ra,3fa <getpid>
  1a:	8a2a                	mv	s4,a0

    int ret = tfork(N, pids);
  1c:	fc040593          	addi	a1,s0,-64
  20:	4511                	li	a0,4
  22:	3f8000ef          	jal	ra,41a <tfork>
    if (ret == 0) {  // CHILD
  26:	cd41                	beqz	a0,be <main+0xbe>
    int pids[N];
  ...
  30:	4501                	li	a0,0
  32:	350000ef          	jal	ra,382 <wait>
  36:	2905                	addiw	s2,s2,1
  38:	ff394ce3          	blt	s2,s3,30 <main+0x30>

    printf("parent: pid=%d\n", parent_id);
  3c:	85d2                	mv	a1,s4
  3e:	00001517          	auipc	a0,0x1
  42:	96250513          	addi	a0,a0,-1694 # 9a0 <malloc+0x110>
  46:	790000ef          	jal	ra,7d6 <printf>

    printf("Parent Process Summary:\n");
  4a:	00001517          	auipc	a0,0x1
  4e:	96650513          	addi	a0,a0,-1690 # 9b0 <malloc+0x120>
  52:	784000ef          	jal	ra,7d6 <printf>
  56:	4901                	li	s2,0
    for (i = 0; i < N; i++) printf("  level %d -> pid %d\n", 1, pids[i]);
  58:	00001a17          	auipc	s4,0x1
  5c:	930a0a13          	addi	s4,s4,-1744 # 988 <malloc+0xf8>
  60:	4090                	lw	a2,0(s1)
  62:	4585                	li	a1,1
  64:	8552                	mv	a0,s4
  66:	770000ef          	jal	ra,7d6 <printf>
  6a:	2905                	addiw	s2,s2,1
  6c:	0491                	addi	s1,s1,4
  6e:	ff3949e3          	blt	s2,s3,60 <main+0x60>

    exit(0);
  72:	4501                	li	a0,0
  74:	306000ef          	jal	ra,37a <exit>
    if (argc > 1) N = atoi(argv[1]);
  78:	6588                	ld	a0,8(a1)
  7a:	1dc000ef          	jal	ra,256 <atoi>
  7e:	89aa                	mv	s3,a0
    int pids[N];
  80:	00251793          	slli	a5,a0,0x2
  84:	07bd                	addi	a5,a5,15
  86:	9bc1                	andi	a5,a5,-16
  88:	40f10133          	sub	sp,sp,a5
  8c:	848a                	mv	s1,sp
    int parent_id = getpid();
  8e:	36c000ef          	jal	ra,3fa <getpid>
  92:	8a2a                	mv	s4,a0
    int ret = tfork(N, pids);
  94:	85a6                	mv	a1,s1
  96:	854e                	mv	a0,s3
  98:	382000ef          	jal	ra,41a <tfork>
    if (ret == 0) {  // CHILD
  9c:	c10d                	beqz	a0,be <main+0xbe>
    for (i = 0; i < N; i++) wait(0);
  9e:	f93048e3          	bgtz	s3,2e <main+0x2e>
    printf("parent: pid=%d\n", parent_id);
  a2:	85d2                	mv	a1,s4
  a4:	00001517          	auipc	a0,0x1
  a8:	8fc50513          	addi	a0,a0,-1796 # 9a0 <malloc+0x110>
  ac:	72a000ef          	jal	ra,7d6 <printf>
    printf("Parent Process Summary:\n");
  b0:	00001517          	auipc	a0,0x1
  b4:	90050513          	addi	a0,a0,-1792 # 9b0 <malloc+0x120>
  b8:	71e000ef          	jal	ra,7d6 <printf>
    for (i = 0; i < N; i++) printf("  level %d -> pid %d\n", 1, pids[i]);
  bc:	bf5d                	j	72 <main+0x72>
        int child_id = getpid();
  be:	33c000ef          	jal	ra,3fa <getpid>
  c2:	84aa                	mv	s1,a0
        pause(child_id % 10);
  c4:	4529                	li	a0,10
